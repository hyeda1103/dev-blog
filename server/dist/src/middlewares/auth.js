...
var authMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(req.headers.authorization && req.headers.authorization.startsWith('Bearer'))) return [3 /*break*/, 6];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                ...
                // Find the user by id
                return [4 /*yield*/, user_1.default.findOne({ _id: decoded._id }).exec(function (err, user) {
                        if (err || !user) {
    ...
    if (req.headers.authorization && req.headers.authorization.startsWith('Bearer')) {
        try {
            ...
            if (token) {
                ...
                // Find the user by id
                user_1.default.findOne({ _id: decoded._id }).exec(function (err, user) {
                    if (err || !user) {
                        return res.status(400).json({
                            error: '사용자를 찾을 수 없습니다'
                        });
